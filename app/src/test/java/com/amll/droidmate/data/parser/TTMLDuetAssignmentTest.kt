...
class TTMLDuetAssignmentTest {
    ...
    @Test
    fun `ttml parser prefers person agent from metadata when available`() {
        val ttml = """
            <?xml version="1.0" encoding="UTF-8"?>
            <tt xmlns="http://www.w3.org/ns/ttml" xmlns:ttm="http://www.w3.org/ns/ttml#metadata">
              <head>
              ...
              <body>
                <div>
                  <p begin="00:00.000" end="00:02.000" ttm:agent="v2">Duet intro</p>
                  <p begin="00:02.000" end="00:04.000" ttm:agent="v2">Duet line</p>
                  <p begin="00:04.000" end="00:06.000" ttm:agent="v1">Main line</p>
                </div>
              </body>
            </tt>
        """.trimIndent()
